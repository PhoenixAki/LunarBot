...
public class Role extends Command {
    ...
    public void action(String[] args, MessageReceivedEvent event){
        ...
        event.getChannel().sendMessage("So " + event.getMember().getAsMention() + ", you want to add or replace a toon role?\n\n***Here is the list of roles we have available for toons:***\n" +
                ...
                "React with the number associated to the role you'd like to be added to your toon.").queue(message -> {
